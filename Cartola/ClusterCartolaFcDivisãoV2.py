...
def divisaoV2(time_tipo_1, time_tipo_2, time_tipo_3, arquivo_div_V2, arquivo_20_div_V2, arquivo_val, rodadaAtual):
    ...
    for jogador in jogadores:
        ...
        if m < 0:
            jogador["Cluster"] =  jogador["Cluster"] / m 
        else: 
            jogador["Cluster"] =  jogador["Cluster"] * m 
   ...
   # -----------------------ATUALIZA O CLUSTER DOS JOGADORES COM O CLUSTER DOS ADVERSÁRIOS----------------------#
    ...
    with open(arquivo_div_V2, 'w', encoding="utf8") as melhores:
        for jogador in jogadores:
    ...
    with open(arquivo_20_div_V2, 'w', encoding="utf8") as melhores:
        cont = 0
        for jogador in jogadores:
