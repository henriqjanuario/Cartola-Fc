...
def divisao(time_tipo_1, time_tipo_2, time_tipo_3):
    ...
    for jogador in jogadores:
        for classi in serie_a:
            if jogador["Adversario"] == classi["Clube"]:
                if jogador["Posiçao"] == 'Atacante' or jogador["Posiçao"] == 'Meia':
                    if jogador["Cluster"] < 0 and classi["Cluster Time Defesa"] > 0:
                        jogador["Cluster"] = (jogador["Cluster"] * classi["Cluster Time Defesa"])
                    elif jogador["Cluster"] > 0 and classi["Cluster Time Defesa"] > 0:
                        jogador["Cluster"] = (jogador["Cluster"] / classi["Cluster Time Defesa"])
    ...
    for jogador in jogadores:
        for classi in serie_a:
            if jogador["Adversario"] == classi["Clube"]:
                if jogador["Posiçao"] == 'Zagueiro' or jogador["Posiçao"] == 'Lateral' or jogador["Posiçao"] == 'Goleiro':
                    if jogador["Cluster"] < 0 and classi["Cluster Time Ataque"] > 0:
                        jogador["Cluster"] = (jogador["Cluster"] * classi["Cluster Time Ataque"])
                    elif jogador["Cluster"] > 0 and classi["Cluster Time Ataque"] > 0:
                        jogador["Cluster"] = (jogador["Cluster"] / classi["Cluster Time Ataque"])
    ...
    with open("C:/Users/rique_000/Documents/GitHub/Cartola-Fc/Cluster/Rodada teste/Melhores para proxima rodada divisão.txt", 'w', encoding="utf8") as melhores:
        for jogador in jogadores:
    ...
    with open("C:/Users/rique_000/Documents/GitHub/Cartola-Fc/Cluster/Rodada teste/20 Melhores para proxima rodada divisão.txt", 'w', encoding="utf8") as melhores:
        cont = 0
        for jogador in jogadores:
