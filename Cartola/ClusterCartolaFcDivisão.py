...
def divisao(time_tipo_1, time_tipo_2, time_tipo_3, arquivo_div, arquivo_20_div, arquivo_val, rodadaAtual):
    ...
    with open(arquivo_20_div, 'w', encoding="utf8") as melhores:
        cont = 0
        for jogador in jogadores:
